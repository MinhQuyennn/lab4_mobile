...
public class MainActivity extends AppCompatActivity {
    ...
    private void writeData() {
        try {
            ...
            FileOutputStream outputStream = openFileOutput("myfile.txt", Context.MODE_APPEND); // Change mode to MODE_APPEND
            outputStream.write(data.getBytes());
            outputStream.write("\n".getBytes()); // Add a newline character for better readability
            outputStream.close();
